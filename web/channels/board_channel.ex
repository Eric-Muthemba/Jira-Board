defmodule PhoenixJiraBoard.BoardChannel do
  ...
  alias PhoenixJiraBoard.{User, Board, UserBoard, List, Card, Comment, CardMember}
    ...
    try do
      ...
      case Repo.insert(changeset) do
        {:ok, _board_user} ->
          ...
          PhoenixJiraBoard.Endpoint.broadcast_from! self(), "users:#{user.id}", "boards:add", %{board: board}
